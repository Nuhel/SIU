     ...
     @section('content')
        ...
        <div class="content-inner">
         ...
         <img src="/storage/uploaded/students/{{$data->picture}}"class="img-thumbnail" style="height: 200px;width: 200px;display: block;margin-left: auto;margin-right: auto;">
          ...
          <div class="col-md-6">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Add Result</h2>
            </div>
            </div>
            <div class="col-md-6">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-12">
                          ...
                          @endif
                              ...
                              @endphp
                        <div class="col-md-12">
                          <a href="{{ url('dashboard/declareCustomizeResult/'.$base64id.'/') }}" class="pull-right btn btn-info">Customize</a>
                        </div>
                      </div>
                    ...
                    success:function(res){
                        if(res){
                            ...
                            $.each(res,function(key,value){
                              $("#subjects").append("<div class='form-group row'> <label class='col-sm-3 form-control-label' for='course_credit'>"+value+"</label> <div class='col-sm-9'> <input name='subid[]' type='hidden' value='"+key+"'><input name='subtype[]' type='hidden' value='Regular'> <select class='form-control mb-3' style='width: 100%;' tabindex='-1' aria-hidden='true' required='1' id='course_credit' name='result[]'><option value='' selected='selected'>Select</option><option value='0.00'>0.00</option><option value='2.00'>2.00</option><option value='2.25'>2.25</option><option value='2.50'>2.50</option><option value='2.75'>2.75</option><option value='3.00'>3.00</option><option value='3.25'>3.25</option><option value='3.50'>3.50</option><option value='3.75'>3.75</option><option value='4.00'>4.00</option></select> </div></div>");
                              count++;
                            ...
                            if(count){
                              $("#addmore").append("<button type='button' data-toggle='modal' data-target='#myModal' class='btn btn-primary'>Add More</button>");
                            }
