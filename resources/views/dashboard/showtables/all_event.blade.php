    ...
    <div class="content-inner">
        ...
        <header class="page-header">
            <div class="container-fluid">
                <h2 class="no-margin-bottom">All Event</h2>
            </div>
        </header>
        ...
        <div class="breadcrumb-holder container-fluid" style="margin:10px">
            <div class="row">
                <div class="col-md-6">
                    <form action="/dashboard/event/search/" method="get" class="sidebar-form">
                        {{ csrf_field() }}
                ...
                <div class="col-md-6">
                        <a href="{{route('show.all_event')}}" class="btn btn-info">Refresh</a>
                </div>
            </div>
        </div>
                                        ...
                                        @if(isset($data))
                                            @foreach($data as $item)
                                                <tr>
                                                    ...
                                                    @else
                                                        <td class="padding_20"><img src='/storage/uploaded/event/{{$item->image}}' style="max-width:60px;max-height:50px" class="img-responsive" /></td>
                                                    @endif
                                                    <td>{{$item->title}}</td>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <a class="btn btn-info" href="{{route('edit.event',$base64id)}}"><span class="fas fa-edit"></span></a>
                                                        <a style="color: #fff;" class="deleteEvent btn btn-danger btn-info"
