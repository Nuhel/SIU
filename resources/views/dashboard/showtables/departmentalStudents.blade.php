        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Departmental Students of {{base64_decode($discipline)}}</h2>
            </div>
          </header>
          ...
          <div class="breadcrumb-holder container-fluid" style="margin:10px">
               <div class="row">
               <div class="col-md-6">
                    <form action="{{ url('/dashboard/DepartmentalStudents/search/'.$discipline.'/') }}"method="get" class="sidebar-form">
                    {{ csrf_field() }}
               ...
               <div class="col-md-6">
                    <a href="{{ url('/dashboard/DepartmentalStudents/'.$discipline.'/') }}" class="btn btn-info">Refresh</a>
               </div>
               </div>
          </div>
				...
				@foreach($data as $item)
                            <tr>
                              ...
                              <td class="text-center">
                                 <a class="btn btn-primary " href="{{ url('dashboard/studentProfile/'.$base64id.'/') }}"><i class="fas fa-user-alt"></i></a>
                                   <a class="btn btn-info " href="{{ url('dashboard/declareResult/'.$base64id.'/') }}"><i class="fas fa-poll-h"></i></a>
