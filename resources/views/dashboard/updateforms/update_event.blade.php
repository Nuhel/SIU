    ...
    <div class="content-inner">
        ...
        <header class="page-header">
            <div class="container-fluid">
                <h2 class="no-margin-bottom text-center">Edit Event</h2>
            </div>
        </header>
                        ...
                        <div class="card" style="width:80%;margin:0 auto;">
                            <div class="card-body">
                                <div class="previous_img" style="display: table;margin: 0 auto;margin-bottom: 15px;">
                                    ...
                                    @else
                                        <img src="/storage/uploaded/event/{{$data->image}}" alt="Image" height="200" style="border-radius: 10px;">
                                        @endif
                                </div>
                                <div class="form-inner">

                                    {!! Form::open(['route' => ['update.event', $data->id],'files' => true])!!}
