        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Update Subject</h2>
            </div>
          </header>
                ...
                <div class="col-lg-12">
                  <div class="card "style="width:80%;margin:0 auto;">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Update subject and semester combination with credit</h3>
                    </div>
                    <div class="card-body">
                      {!! Form::open(['method' => 'POST','action' => 'SubjectController@update','class' => 'form-horizontal']) !!}
                        <div class="form-group row">
                          {!! Form::label('course_title', "Course Title",['class'=>'col-sm-3 form-control-label']) !!}
                           {{ Form::hidden('id',$id) }}
                          <div class="col-sm-9">
                            {!! Form::text('course_title', $data->course_title, ['class' => 'form-control form-control-success','placeholder' => "Course Title",'required' => '1']) !!}
                            @if(count($errors)>0)
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            {!! Form::text('course_code', $data->course_code, ['class' => 'form-control form-control-success','placeholder' => "Course Code",'required' => '1']) !!}
                            @if(count($errors)>0)
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            {!! Form::select('course_credit', array('' => 'Select','1.0' => '1.0','1.5' => '1.5','2.0' => '2.0','2.5' => '2.5','3.0' => '3.0','3.5' => '3.5','4.0' => '4.0'), $data->course_credit, ['class' => 'form-control mb-3', 'style'=>'width: 100%;','tabindex'=>'-1','aria-hidden'=>'true','required' => '1'])!!}
                            @if(count($errors)>0)
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                             {!! Form::select('discipline', array('' => 'Select','CSE' => 'CSE','ECE' => 'ECE','EEE' => 'EEE','BBA' => 'BBA','LLB' => 'LLB','ENG' => 'ENG'), $data->discipline, ['class' => 'form-control mb-3', 'style'=>'width: 100%;','tabindex'=>'-1','aria-hidden'=>'true','required' => '1'])!!}
                            @if(count($errors)>0)
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                             {!! Form::select('semester', array('' => 'Select','1-1' => '1-1','1-2' => '1-2','2-1' => '2-1','2-2' => '2-2','3-1' => '3-1','3-2' => '3-2','4-1' => '4-1','4-2' => '4-2'), $data->semester, ['class' => 'form-control mb-3', 'style'=>'width: 100%;','tabindex'=>'-1','aria-hidden'=>'true','required' => '1'])!!}
                            @if(count($errors)>0)
