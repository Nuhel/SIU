...
<title>@yield('pageTitle')SIU | Department Of CSI</title>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                ...
                                <div id="home-tab-content" class="tab-content custom_tab_content">
                                    <div class="tab-pane  active" id="overview">
                                        <h4>Department Of Computer Science And Informatics</h4>
                                        ...
                                        <div class="sroll_bar_t collapse_box" id="collapse_box" >
                                            <table class="tbl">
                                                ...
                                                <tr class="tr_head" >
                                                    ...
                                                    <td style="text-align: center;">16,000 x 8 = 1,28,000 BDT</td>
                                                    <td style="text-align: center;">2,40,000 BDT</td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
