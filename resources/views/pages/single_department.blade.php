                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                ...
                                <div id="home-tab-content" class="tab-content custom_tab_content">
                                    <div class="tab-pane  active" id="overview">
                                        ...
                                        <p>Department of Computer Science and Engineering of Sylhet International University started from Fall 2001. The mission and vision are to impart and improve the theoretical knowledge and practical skills of students in Computer Science and Engineering, keeping pace with the development while significantly contributing to the wealth of knowledge by way of high quality education and research.
                                            Outcome based education has become very important in the challenging world. So the curriculum of CSE Department has been designed so that it can cover a broad range of disciplines related to Computer Hardware-Software, Network Communication, Computer Algorithm, Programming Languages, Database Systems, Artificial Intelligence, Computer Graphics, Digital Image Processing etc. Well designed laboratories have been established to support these programs. The laboratories are regularly upgraded to accommodate new technologies.
                                            The Department is extremely fortunate to work with a wonderful group of individuals who have common goals.....
                                        </p>
